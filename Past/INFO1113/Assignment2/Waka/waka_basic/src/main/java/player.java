public class player {
    ...
    public player(mainFrame windowsFrame, int origX, int origY, int speed){
    ...
    public boolean isWall(int nextX, int nextY){
        return !(windowsFrame.gameMaps[nextY][nextX] == 0 || windowsFrame.gameMaps[nextY][nextX] == 7);
    }
    /**
     * what predict do:
    ...
    public message run() {
        ...
        return new message(X, Y, previousDirection);
    }
}
